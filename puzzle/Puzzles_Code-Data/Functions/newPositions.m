...
%piece
    ...
    for i = 2:1:length(placements)
        ...
        xMotion(i-1) = (placements(i).g_lock(2))/10; %change motion x
        yMotion(i-1) = (placements(i).g_lock(3))/10;  %change motion y
        ...
        xpos(i-1) = positions(1)/10;
        ypos(i-1) = positions(2)/10;
    end
